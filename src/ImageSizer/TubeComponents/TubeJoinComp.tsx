        ...
        <TubeCompCont>
            <ConfigComp>
                <RsNumber
                    ...
                    helpTitle={_('Number of pieces joined together. 0 means no limit.')}
                    step={1}
                    min={0}
                />
                <RsNumber
                ...
                <RsNumber
                    ...
                    step={1}
                    min={0}
                    helpTitle={_('Adds vertival gap between joined pieces')}
                />
                <RsNumber
                    ...
                    step={1}
                    min={0}
                    helpTitle={_('Adds horizontal gap between joined pieces')}
                />
            </ConfigComp>
