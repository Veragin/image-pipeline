            ...
            <ConfigRow>
                <ConfigComp>
                    ...
                    <RsNumber
                        ...
                        step={1}
                        min={0}
                        helpTitle={_('Minimal number of compact pixels that define an object.')}
                    />
                    <RsNumber
                        ...
                        step={1}
                        min={0}
                        helpTitle={_('Minimal width of compact pixels that define an object.')}
                    />
                    <RsNumber
                        ...
                        step={1}
                        min={0}
                        helpTitle={_('Minimal height of compact pixels that define an object.')}
                    />
                </ConfigComp>
                <ConfigComp>
                    <BbConfig
