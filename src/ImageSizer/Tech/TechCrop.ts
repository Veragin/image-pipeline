...
} from 'ImageSIzer/functions/rectTricks';
import { selectionFromRectToSelection, selectionToRect } from 'ImageSIzer/functions/rectSelection';

import CropRoundedIcon from '@mui/icons-material/CropRounded';
import { ImageCollection } from 'ImageSIzer/ImageColection';
import { Tech } from './Tech';
import { TechCropComp } from '../TechComponents/TechCropComp';
import { cutImageDataByRect } from 'ImageSIzer/functions/cutter';
